    ...
    function hitung()
    {
                ...
                if($this->ft[$key] != 0 ){
                    $this->selisih[$key] =  $this->ft[$key] - $k_temp; 
                        if ($this->selisih[$key] > 0) {
                            ...
                            if($this->q == 2) {
                                $this->ft_p[$key] = $this->ft[$key] + (0.75 * $this->selisih[$key]);
                            }
                            ...
                            if($this->q == 4) {
                                $this->ft_p[$key] = $this->ft[$key] + (0.25 * $this->selisih[$key]);
                            }
        ...
        for ($a = 1; $a <= $this->next_periode; $a++) {
            ...
            if ($this->selisih[$key] > 0) {
                ...
                if($this->q == 2) {
                    $this->next_ft_p[$key] = $this->next_ft[$key] + (0.75 * $this->selisih[$key]);
                }
                ...
                if($this->q == 4) {
                    $this->next_ft_p[$key] = $this->next_ft[$key] + (0.25 * $this->selisih[$key]);
                }
