  ...
  <div class="page-heading">
                ...
                <table class="table table-borderless mb-0">
                  ...
                  <?php foreach ($prediksi_value as $key => $val) :
                      ...
                      <tr>
                        ...
                        <td><?= isset($nilai_prediksi->ft[$key]) ? $nilai_prediksi->ft[$key] : '' ?></td>
                        <td><?= isset($nilai_prediksi->e[$key]) ? round($nilai_prediksi->e[$key], 4) : '' ?></td>
                        <td><?= isset($nilai_prediksi->e_abs[$key]) ?  round($nilai_prediksi->e_abs[$key], 4) : '' ?></td>
                        <td><?= isset($nilai_prediksi->e2[$key]) ?  round($nilai_prediksi->e2[$key], 4) : '' ?></td>
                        <td><?= isset($nilai_prediksi->e_abs_yt[$key]) ? round($nilai_prediksi->e_abs_yt[$key], 4)  : '' ?></td>
                      </tr>
                  <?php endforeach ?>
                  </tbody>
              </table>
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="d-inline-flex justify-content-center flex-grow-1">
        @if ($nilai_prediksi -> yt['Semester 5'] > $nilai_prediksi -> ft_next[0])
