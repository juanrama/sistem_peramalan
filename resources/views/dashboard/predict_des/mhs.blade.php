...
<div id="main">
  ...
  <div class="page-heading">
    ...
    <section class="section">
      <div class="card">
        <div class="card-body">
          <form action="/des/mahasiswa" method="GET">
            @csrf
            <div class="row mb-3">
              <div class="col-md-6">
          ...
          <div class="card-body">
              <form method="get" action="/des/mahasiswa/despred">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                          <input id="alpha" type="number" class="form-control @error('alpha') is-invalid @enderror" name="alpha" value="{{ old('alpha') }}" step="0.1" min="0" max="0.99" required autocomplete="alpha" autofocus>
                      </div>
                </div>
                <div class="form-group row">
