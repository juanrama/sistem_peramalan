          ...
          <div class="col-md-6 col-12">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <form method="post" action="/database/akademik" class="form form-horizontal">
                    @csrf
                    <div class="form-body">
                      <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                          ...
                          <div class="col-md-8 form-group">
                            <select id="q_kab" class="form-control @error('q_kab') is-invalid @enderror" name="q_kab">
                          ...
                          <div class="col-md-8 form-group">
                            <select id="q_jk" class="form-control @error('q_jk') is-invalid @enderror" name="q_jk">
                              @foreach ($q_jk as $jk)
                                <option>{{ $jk }}</option>
                              @endforeach
                            </select>
                          ...
                          <div class="col-md-8 form-group">
                            <select id="q_sma" class="form-control @error('q_sma') is-invalid @enderror" name="q_sma">
