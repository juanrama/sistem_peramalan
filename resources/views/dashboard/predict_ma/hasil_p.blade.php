  ...
  <div class="page-heading">
                ...
                <table class="table table-borderless mb-0">
                  ...
                  <?php foreach ($prediksi_value as $key => $val) :
                      ...
                      <tr>
                        ...
                        <td><?= $nilai_prediksi->ft_p[$key] ?></td>
                        <td><?= isset($nilai_prediksi->et_p[$key]) ? number_format($nilai_prediksi->et_p[$key], 2) : '' ?></td>
                        <td><?= isset($nilai_prediksi->et_square_p[$key]) ? number_format($nilai_prediksi->et_square_p[$key], 2) : '' ?></td>
                        <td><?= isset($nilai_prediksi->et_abs_p[$key]) ? number_format($nilai_prediksi->et_abs_p[$key], 2) : '' ?></td>
                        <td><?= isset($nilai_prediksi->et_yt_p[$key]) ? number_format($nilai_prediksi->et_yt_p[$key], 2) : '' ?></td>
                      </tr>
                  <?php endforeach ?>
                  </tbody>
              </table>
          ...
          <div class="card-content">
            ...
            <div class="table-responsive">
              <table class="table table-borderless mb-0">
                ...
                <tbody>
                    <?php foreach ($nilai_prediksi->next_ft_p as $key => $val) :
                    ?>
                      <tr>
                          <td>Semester 7</td>
                          <td><?= $val ?></td>
                ...
                <table class="table table-borderless mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?= number_format($nilai_prediksi->error['MSE_p'], 2) ?></td>
                      </tr>
                      <tr>
                        <td>RMSE</td>
                        <td><?= number_format($nilai_prediksi->error['RMSE'], 2) ?></td>
                        <td><?= number_format($nilai_prediksi->error['RMSE_p'], 2) ?></td>
                      </tr>
                      <tr>
                        <td>MAD</td>
                        <td><?= number_format($nilai_prediksi->error['MAE'], 2) ?></td>
                        <td><?= number_format($nilai_prediksi->error['MAE_p'], 2) ?></td>
                      </tr>
                      <tr>
                        <td>MAPE</td>
                        <td><?= number_format($nilai_prediksi->error['MAPE'], 2) ?>%</td>
                        <td><?= number_format($nilai_prediksi->error['MAPE_p'], 2) ?>%</td>
                      </tr>
                    </tbody>
                </table>
          </div>
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="d-inline-flex justify-content-center flex-grow-1">
        @if ($nilai_prediksi -> ft['Semester 6'] > $nilai_prediksi -> next_ft_p['Semester 7'])
